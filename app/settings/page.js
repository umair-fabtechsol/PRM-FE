...
import Coustomizations from './Coustomizations'
...
const page = () => {
    ...
    const Array = [
        ...
        },
        {
            ...
            Icon: (isActive) => (
                <svg style={{ fill: isActive ? "white" : "#2E2E2E" }} width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M11.9993 7.33329L13.0565 6.2761C13.5772 5.7554 13.5772 4.91119 13.0565 4.39049L11.6088 2.94277C11.0881 2.42207 10.2439 2.42207 9.72321 2.94277L8.66602 3.99996M11.9993 7.33329L5.99935 13.3333H2.66602V9.99996L8.66602 3.99996M11.9993 7.33329L8.66602 3.99996" stroke="#2E2E2E" strokeWidth="1.5" strokeLinecap="round" stroke-linejoin="round" />
                </svg>
            )
        },
        {
    ...
    return (
        <>
            ...
            />
            <div className="p-6 flex bg-[#fafafa]   bg-transparent">
                <div className=' w-1/4 '>
                    <div className="flex  flex-wrap ">
                        <ul className="mt-4 space-y-2">
                            {Array.map((item, index) => (
                                <li key={index} onClick={() => handleTabClick(item.path)} className={` cursor-pointer rounded-lg px-4 py-1 ${activeTab === item.path ? "bg-[#3366cc] text-white" : "bg-transparent text-[#2E2E2E]"} flex items-center space-x-2`}>
