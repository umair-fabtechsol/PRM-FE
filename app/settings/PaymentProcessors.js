  ...
  return (
    <>
      <div className="bg-white min-h-screen relative  rounded-lg shadow-md w-full max-w-4xl">
        <h2 className=" text-[#2E2E2E] text-sm border-b-2 p-4 font-Inter font-bold  mb-6">Payment Processors</h2>
        <div className='px-4'>
          <div className="flex items-center p-4 bg-white rounded-lg shadow-md max-w-full mx-auto mt-10">
            ...
            <div className="ml-4">
              ...
              <p className="text-gray-600 w-3/4">Seamlessly connect your Stripe account to manage secure payments and transactions.</p>
            </div>
          ...
          <div className="flex items-center p-4 bg-white rounded-lg shadow-md max-w-full mx-auto mt-10">
            <div className="flex-shrink-0">
              <div className='bg-[#ebf0fa] rounded-full p-2'>
                <div className="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center">
                  <span className="text-blue-600 text-2xl font-bold"><img src='/paypal-svgrepo-com.svg' /></span>
                </div>
              </div>
            </div>
            <div className="ml-4">
              <h2 className="text-lg font-semibold">Paypal</h2>
              <p className="text-gray-600 w-3/4">Link Your Paypal Account  to enable smooth transactions</p>
            </div>
            <div className="ml-auto">
              <label className="inline-flex items-center cursor-pointer">
                <input type="checkbox" defaultValue="" className="sr-only peer" />
