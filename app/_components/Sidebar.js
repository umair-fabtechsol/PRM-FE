        ...
        >
          <div className='bg-white w-[350px] rounded-lg p-6 shadow-lg relative'>
            <div className='flex justify-left my-2 text-red-500'>
              <img src='/icons/logout.png' alt='Add Widget' className='mr-2' width={60} height={60} />
            </div>

            <h2 className='text-left p-2 text-lg font-bold text-black'>Logout</h2>

            <p className='text-left  text-sm text-gray-500 mt-2'>Are you sure you want to log out?</p>
