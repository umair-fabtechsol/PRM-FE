        ...
        <div className='fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50'>
          <div className='bg-white w-[400px]   rounded-lg p-6 shadow-lg relative'>
            <div className='flex justify-left my-2 text-red-500'>
              <img src='/icons/addwidgets.png' alt='Add Widget' className='mr-2' width={40} height={40} />
            </div>

            <h2 className='text-left p-2 text-lg font-semibold text-black'>Custome Widget</h2>
            ...
            <div className='my-4'>
              ...
              <input
                ...
                className='w-full p-2 bg-white border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 text-black'
              />
              <label htmlFor='widget-description' className='block text-sm  text-gray-700 mt-4 mb-1'>
                Enter Widget Code
              </label>
              <textarea
      ...
      <div className='p-6 min-h-screen bg-transparent'>
        ...
        <div className='mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6'>
          <div className='bg-white p-6 rounded-md shadow-md flex flex-col justify-between h-full'>
            <div>
              <div className='flex items-center'>
                <p className='text-sm text-black font-bold mr-2'>Total Revenue</p>
              </div>
          ...
          <div className='bg-white p-6 rounded-md shadow-md flex flex-col justify-between h-full'>
            <div>
              <div className='flex items-center'>
                <p className='text-sm text-black font-bold mr-2'>Active affiliates</p>
              </div>
              <h1 className='text-2xl text-black font-semibold my-3'>250</h1>
            </div>
            <div className='mt-2 text-sm text-gray-700  flex items-center'>affiliate contributing</div>
          </div>

          <div className='bg-white p-6 rounded-md shadow-md flex flex-col justify-between h-full'>
            <div>
              <div className='flex items-center'>
                <p className='text-sm text-black font-bold mr-2'>top campaign</p>
              </div>
          ...
          <div className='bg-white p-6 rounded-md shadow-md flex flex-col justify-between h-full'>
            <div>
              <div className='flex items-center'>
                <p className='text-sm text-black font-bold mr-2'>Converstion rate</p>
              </div>
              <h1 className='text-2xl text-black font-semibold my-3'>5.5%</h1>
            </div>
            <div className='mt-2 text-sm text-gray-700  flex items-center'>Average CTR</div>
          </div>
        </div>
      </div>
    </PrivateRoute>
