      ...
      <div className='py-2 lg:px-6 px-3  min-h-screen bg-transparent'>
        <div className='mt-2 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6'>
          <div className='bg-white p-6 rounded-md shadow-md flex flex-col justify-between h-full'>
            <div>
              <div className='flex items-center'>
                <p className='text-sm text-black font-bold mr-2'>Total Commision</p>
              </div>
              <h1 className='text-2xl text-black font-semibold my-3'>15%</h1>
            </div>
            <div className='mt-2 text-sm text-gray-700  flex items-center'>across all partners</div>
          </div>

          <div className='bg-white p-6 rounded-md shadow-md flex flex-col justify-between h-full'>
            <div>
              <div className='flex items-center'>
                <p className='text-sm text-black font-bold mr-2'>Total Paid out</p>
              </div>
              <h1 className='text-2xl text-black font-semibold my-3'>$1,000,000</h1>
            </div>
          ...
          <div className='bg-white p-6 rounded-md shadow-md flex flex-col justify-between h-full'>
            <div>
              <div className='flex items-center'>
                <p className='text-sm text-black font-bold mr-2'>pending payouts</p>
              </div>
              <h1 className='text-2xl text-black font-semibold my-3'>$25,000</h1>
            </div>
        ...
        <div className='py-6 min-h-screen'>
          <div className='flex items-center justify-between  pb-4'>
            <div className='flex items-center border border-gray-300 rounded px-2 py-1 w-full max-w-sm bg-white'>
              ...
              <input type='text' placeholder='Search' className='flex-1 outline-none bg-white text-gray-700' />
