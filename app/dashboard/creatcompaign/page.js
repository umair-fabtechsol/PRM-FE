...
export default function CreateCampaignPage() {
  ...
  const steps = ['General Info', 'Goals', 'Assets', 'Text', 'Configure', 'Calendar', 'Review'];
  ...
  return (
    <PrivateRoute>
      {/* new code */}
      <TaskModal setTaskModalData={setTaskModalData} isOpen={isOpenTaskModal} closeModal={closeModal} />
      <BroadcastModal isOpen={isOpenBroadcastModal} closeModal={closeBroadcastModal} />
          ...
          <div className='mb-6'>
            ...
            <div className='flex justify-around px-3 mt-2'>
              {steps.map((step, index) => (
                <div
                  key={index}
                  className={`text-center text-sm ${index <= currentStep ? 'text-blue-500 ' : 'text-gray-500'}`}
                >
                  {step}
                </div>
              ))}
                    ...
                    {images.map((image, index) => (
                      ...
                      >
                        <div className='flex items-center w-full'>
                          <img alt={`Uploaded ${index}`} className='w-10 h-10 mr-4' src={URL.createObjectURL(image)} />
                          <div className='w-full'>
                            <p
                              className={`text-sm inline ${
                                uploadProgress[image.name] === 100 ? 'text-black' : 'text-gray-500'
                              }`}
                            >
                              {image.name}
                            </p>
                            <Link
                              className={`text-blue-500 text-xs ml-2 inline ${
                                uploadProgress[image.name] === 100 ? 'block' : 'hidden'
                              }`}
                              href='#'
                            >
                              Preview
                        ...
                        <div className='text-gray-500 text-xs ml-auto'>{(image.size / 1024 / 1024).toFixed(2)} MB</div>
                ...
                <form>
                  <div className=' rounded-lg flex md:flex-row flex-col gap-4'>
                    <div className=' md:w-3/5 w-full'>
                      {/* Site Link Input */}
                      <h3 className='text-lg font-semibold text-black'>Site Link</h3>
                    ...
                    <div className='md:w-2/5 w-full'>
                      <div className='p-4 border border-gray-300 rounded-lg bg-white '>
                        <h3 className='text-lg font-semibold text-black'>Review & Share</h3>
                        <p className='text-sm text-black'>
                          Edit any fields below or re-select a different element on the left and then hit save.{' '}
                        </p>

                        <div className='mt-4'>
                          <label className='block text-black'>Target Element Selector</label>
                          <input
                            type='text'
                            value={siteLink}
                            className='w-full outline-none bg-white border border-gray-300 px-4 py-2 rounded-md shadow-sm text-black text-sm'
                        ...
                        <div className='mt-4'>
                          <label className='block text-black'>Conversation Rate</label>
                          <input
                            type='text'
                            placeholder='$'
                            className='w-full outline-none bg-white border border-gray-300 px-4 py-2 rounded-md shadow-sm text-black text-sm'
                ...
                <form>
                  ...
                  <div className='flex justify-start'>
                    <div className='w-1/2 my-2 rounded-md bg-transparent'>
                      <p className='text-gray-700 text-sm mb-2'>Overriding settings</p>{' '}
                      <div className='grid grid-cols-1 sm:grid-cols-2 gap-4'>
                        <div className='flex flex-col w-full'>
                          <label htmlFor='select1' className='text-gray-700 text-sm'>
                            Tag/ Partner
                          </label>
                          <select
                            id='select1'
                    ...
                    <FullCalendar
                      dayHeaderContent={arg => (
                        ...
                        >
                          ...
                          <span className='font-Inter font-medium text-black text-xl'>{arg.date.getDate()}</span>
                        </span>
                      )}
                      ref={calendarRef}
                      initialView={view}
                      ...
                      eventContent={arg => {
                        ...
                        return (
                          ...
                          >
                            <div style={{ fontSize: '12px', color: '#555' }}>{startTime}</div>
                            <div
                              style={{
                                fontWeight: 'bold',
                                fontSize: '14px',
                ...
                <div className='px-2 bg-transparent'>
                  ...
                  <div className='py-2   my-2'>
                    ...
                    <p className='text-gray-700 text-xs'>
                      {' '}
                      This is a dummy description text. It should be around 50 to 60 words in length. You can replace it
                      with your actual data as needed. This is a dummy description text. It should be around 50 to 60
                      words in length. You can replace it with your actual data as needed. should be around 50 to 60
                      words in length. You can replace it with your actual data as needed.
                    </p>
                  </div>
                  ...
                  <div className='py-2   my-2'>
                    ...
                    <p className='text-gray-700 text-xs'>
                      {' '}
                      This is a note text. It contains approximately 30 words and can be replaced with actual
                      information as required. This is a note text. It contains approximately 30 words and can be
                      replaced with actual information as required.
                    </p>
                  </div>
