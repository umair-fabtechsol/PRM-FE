...
const page = () => {
  const notifications = [
    {
      id: 1,
      text: "Campaign 'Holiday Sale' reached 10,000 impressions.",
      date: "Nov 13, 2024 4:34 am",
      unread: true,
    },
    {
      id: 2,
      text: "Campaign 'Holiday Sale' reached 10,000 impressions.",
      date: "Nov 14, 2024 1:17 pm",
      unread: true,
    },
    {
      id: 3,
      text: "Affiliate John Doe generated $500 in revenue this week.",
      date: "Nov 29, 2024 7:45 pm",
      unread: false,
    },
    {
      id: 4,
      text: "Review pending affiliate applications.",
      date: "Nov 18, 2024 5:35 pm",
      unread: false,
    },
  ];
  return (
      ...
      <div className="max-w-full mx-auto p-6">
        <div className="flex justify-between items-center mb-4">
          <div className="flex space-x-2">
            <button className="px-4 py-2 bg-[#3366CC] text-white rounded-lg">
              All
            </button>
