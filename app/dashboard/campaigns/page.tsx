...
import CampaignsTable from './_components/CampaignTable';
      ...
      {campaignDeleteModal && (
        <div className='fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50'>
          <div className='bg-white w-[350px] rounded-lg p-6 shadow-lg relative'>
            ...
            <h2 className='text-left p-2 text-lg font-semibold text-black'>Delete Campaign</h2>

            <p className='text-left  text-sm text-gray-500 mt-2'>Are you sure you want to delete this campaign?</p>
