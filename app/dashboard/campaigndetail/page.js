      ...
      <div className='px-6 py-2 min-h-screen bg-transparent'>
        <div className='my-2 flex justify-end'>
          <Link href='#'>
            <button className='text-gray-700 hover:text-blue-700 mx-2 px-2'>
              <img src='/icons/edit.png' alt='Custom Icon' className='w-6 h-6 ' />
            </button>
          </Link>

          <Link href='#'>
            <button className='text-gray-700 hover:text-blue-700 mx-2 px-2'>
              <img src='/icons/delete.png' alt='Custom Icon' className='w-6 h-6 ' />
            </button>
          </Link>
        </div>
        ...
        <div className='py-2   my-2'>
          ...
          <p className='text-gray-700 text-xs'>
            {' '}
            This is a dummy description text. It should be around 50 to 60 words in length. You can replace it with your
            actual data as needed. This is a dummy description text. It should be around 50 to 60 words in length. You
            can replace it with your actual data as needed. should be around 50 to 60 words in length. You can replace
            it with your actual data as needed.
          </p>
        </div>
        ...
        <div className='py-2   my-2'>
          ...
          <p className='text-gray-700 text-xs'>
            {' '}
            This is a note text. It contains approximately 30 words and can be replaced with actual information as
            required. This is a note text. It contains approximately 30 words and can be replaced with actual
