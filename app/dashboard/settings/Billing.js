    ...
    <>
      ...
      <div className="bg-white min-h-screen relative  rounded-lg shadow-md w-full max-w-4xl">
        <div className='flex  justify-between  p-4  border-b-2 items-center '>
          ...
          <button onClick={() => setIsOpen(true)} className='bg-[#3366CC] flex gap-3 justify-center items-center px-4 py-2 rounded-lg font-Inter font-semibold text-sm text-[#FFFFFF]'>
                        ...
                        <tr>
                          ...
                          >
                            <button className="flex items-center gap-2 justify-center focus:outline-none">
                              <span className="font-Inter text-xs text-[#535862] font-medium ">Plan Name</span>
                            </button>
                          </th>
                          <th
                            scope="col"
